    ...
    with open(topofile, 'r') as f:
        ...
        for line in f:
            if line.startswith('Switch'):
                ...
                g.add_node(guid, label=nodedesc, type='Host',color=get_host_color(nodedesc))
                ...
                try:
                    ...
                    g.add_edge(guid, destguid, weight=w,color=get_link_color(ls[-1]))
                    g[guid][destguid]['penwidth'] = 1
    return g
